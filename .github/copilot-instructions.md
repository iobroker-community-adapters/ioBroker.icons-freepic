...
8. [Adapter-Specific Guidelines](#adapter-specific-guidelines)
   - [Development Guidelines](#development-guidelines)
   - [WWW-Only Adapter Patterns](#www-only-adapter-patterns)
   - [Copyright and Legal Compliance](#copyright-and-legal-compliance)
   - [CI/CD for WWW-Only Adapters](#cicd-for-www-only-adapters)
...
#### Testing for WWW-Only Adapters

For WWW-only adapters like icons-freepic (mode: "none"), integration tests should focus on object configuration and static file serving rather than runtime behavior:
...
### CI/CD for WWW-Only Adapters

WWW-only adapters have simpler CI/CD requirements than runtime adapters:
